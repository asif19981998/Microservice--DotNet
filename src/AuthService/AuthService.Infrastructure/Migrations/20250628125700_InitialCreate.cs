...
namespace AuthService.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RolePolicies_AspNetUsers_GrantedBy",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_ApplicationId",
                table: "AspNetRoles",
                column: "ApplicationId");

            migrationBuilder.CreateIndex(
                name: "IX_AspNetRoles_Name_ApplicationId_TenantId",
                table: "AspNetRoles",
                columns: new[] { "Name", "ApplicationId", "TenantId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RolePolicies_GrantedBy",
                table: "RolePolicies",
                column: "GrantedBy");
